...
> If one class dominates the dataset, it will naturally result in high accuracy even if all predictions are done as majority class. Like non exited who are 80%. Even if all are non exited still the accuracy will be 80% but we will miss the crucial 20% whom we are targetting fir analysis. 
...
> All three decreased slighlty from training to test data.
